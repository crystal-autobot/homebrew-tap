class Autobot < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/crystal-autobot/autobot/releases/download/v0.2.1/autobot-darwin-arm64.tar.gz"
      sha256 "c598b456584b813ead087961a5208ea37996c521980f2339a254461a763dd510"
    end
